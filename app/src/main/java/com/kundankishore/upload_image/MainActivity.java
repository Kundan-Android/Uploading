    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPickImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(gallaryIntent,0);
            }
        });
        ...
        switch (requestCode) {
            ...
            case RequestPermissionCode:
                ...
                if (grantResults.length > 0) {
                    ...
                    boolean ReadStorgaePermission = grantResults[0] == PackageManager.PERMISSION_GRANTED;

                    if (ReadStorgaePermission) {
...
try{
        if (requestCode == 0 && resultCode == RESULT_OK && null != data){
            ...
            String[] filePathCoulumn = {MediaStore.Images.Media.DATA};
            Cursor cursor = getContentResolver().query(selectedImage,filePathCoulumn,null, null, null);
            assert cursor != null;
            cursor.moveToFirst();

            int columnIndex = cursor.getColumnIndex(filePathCoulumn[0]);
